...
<html class="no-js" lang="en">
    <head>
       ...
       <!-- <title>{{ config('app.name', 'Online Shop') }}</title>-->
		...
		<!-- all css here -->
        <link rel="stylesheet" href="https://fonts.cdnfonts.com/css/berlin">
                ...
                <div class="container-fluid">
                    <div class="header-bottom-wrapper">
                        ...
                        <div class="menu-style-2 furniture-menu menu-hover">
                            <nav>
                                <ul>
                                    <li><h3 style="font-family: 'Berlin XBold', sans-serif;" href="/">home</h3>
                                        <ul class="single-dropdown">
                                            <li><a href="index.html">Fashion</></li>
                                    ...
                                    <li><h3 style="font-family: 'Berlin XBold', sans-serif;"href="#">pages</h3>
                                        <ul class="single-dropdown">
                                    ...
                                    <li><h3 style="font-family: 'Berlin XBold', sans-serif;" href="{{ url('products') }}">shop</h3>
                                    ...
                                    <li><h3 style="font-family: 'Berlin XBold', sans-serif;" href="blog.html">blog</h3>
                                        <ul class="single-dropdown">
                                    ...
                                    <li><h3 style="font-family: 'Berlin XBold', sans-serif;" href="contact.html">contact</h3></li>
                                </ul>
                            </nav>
                        </div>
                ...
                <div class="services-wrapper">
                    <div class="single-services mb-40">
                        ...
                        <div class="services-content">
                            ...
                            <p>  KIRIMAN AMAN DAN TERPERCAYA
                            ✅  Harga Terjangkau: Kami menawarkan tarif pengiriman yang kompetitif dan terjangkau, sehingga Anda dapat menghemat uang Anda.                          </p>
                        </div>
                    </div>
                    <div class="single-services mb-40">
                        <div class="services-img">
                        ...
                        <div class="services-content">
                            <h4>Keamanan Pembayaran yang Terjamin </h4>
                            <p>Kami berkomitmen untuk menjaga keamanan pembayaran Anda dan
                                 memberikan perlindungan terbaik bagi Anda sebagai pelanggan kami.
                                  Dengan demikian,Anda dapat berbelanja dan bertransaksi dengan percaya diri,
                                   mengetahui bahwa data Anda dalam keadaan aman.. </p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="widget-wrapper">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-about-2">
                                <p>E-commerce Elektronet: Solusi Terbaik untuk Kebutuhan Elektronik Anda </p>
                                <h5> Kami bangga menjadi platform e-commerce </h5>
                                <h5>yang menyediakan berbagai produk elektronik terbaik</h5>
                         </div>
                        </div>
                        <div class="footer-widget mb-30">
